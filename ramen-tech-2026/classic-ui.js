...
(()=>{
  ...
  if(!hero||hero.dataset.classic==='20260911k1')return;
  const initialHash=location.hash;
  hero.dataset.classic='20260911k1';hero.classList.add('classic-hero');
  ...
  const kyushuStyle=document.createElement('link');kyushuStyle.rel='stylesheet';kyushuStyle.href='kyushu-entry.css?v=20260911k1';document.head.appendChild(kyushuStyle);
  ...
  const kyushuEntry=document.createElement('a');kyushuEntry.className='kyushu-entry';kyushuEntry.href='kyushu/';kyushuEntry.innerHTML='<img src="kyushu/images/nagasaki-kunchi.webp" alt="長崎くんち・過去開催の様子" width="230" height="164" loading="lazy"><div><small>NEW / KYUSHU AUTUMN 2026</small><strong>福岡に来たら、九州まで遊ぼう。</strong><p>9/21〜10/21の音楽・アート・祭り・食の寄り道へ。</p></div><span aria-hidden="true">↗</span>';ticker.after(kyushuEntry);
