...
(()=>{
  ...
  if(!hero||hero.dataset.classic==='20260912k3')return;
  const initialHash=location.hash;
  hero.dataset.classic='20260912k3';hero.classList.add('classic-hero');
  ...
  const kyushuStyle=document.createElement('link');kyushuStyle.rel='stylesheet';kyushuStyle.href='kyushu-entry.css?v=20260912k3';document.head.appendChild(kyushuStyle);
